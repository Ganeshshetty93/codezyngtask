...
// 1. CRITICAL FIX: Ensure dotenv is configured at the absolute top of the file
// If this script is run directly via node/nodemon, it will locate the .env in its parent/current folder context
const path = require('path');
require('dotenv').config({ path: path.resolve(__dirname, '../.env') }); 

const { Client } = require('pg');

// 2. CRITICAL FIX: Graceful structural check for missing or undefined URL parameters
